...
export const SELECT_STRATEGY_QUESTION_CHOICES = [DependenciesStrategy.NPM, DependenciesStrategy.Yarn, DependenciesStrategy.Forge, DependenciesStrategy.Other];
